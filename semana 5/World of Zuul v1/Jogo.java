...
public class Jogo 
{
    ...
    private void criarAmbientes()
    {
        ...
        anfiteatro.ajustarSaida("cima", sotao);

        sotao.ajustarSaida("baixo", anfiteatro);
    ...
    private void atualizarAmbiente(Ambiente ambiente) {
        ...
        imprimirSaidas(ambienteAtual);
    }

private void imprimirSaidas(Ambiente ambiente) {
    System.out.print("Saidas: ");
    System.out.println(ambiente.getSaidasDisponiveis());
}
    ...
    private void observar() {
        System.out.println("Voce esta " + ambienteAtual.getDescricao());
        System.out.print("Saidas: ");
        System.out.println(ambienteAtual.getSaidasDisponiveis());
    }
    ...
    private void imprimirAjuda() 
    {
        ...
        PalavrasComando palavras = new PalavrasComando();
        palavras.imprimirComandos();
    }
...
private void irParaAmbiente(Comando comando) 
{
    ...
    if (proximoAmbiente == null) {
        ...
        atualizarAmbiente(proximoAmbiente);
    }
}
