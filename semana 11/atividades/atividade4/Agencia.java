...
public class Agencia{
  ...
  public void depositar(int numeroConta, double valor){
    ...
    if(contaDestino != null){
      ...
      throw new RuntimeException("ERRO: Conta não foi encontrada.");
    }
  }
  ...
  public void transferir(int numeroContaOrigem, int numeroContaDestino, double valor) throws SaldoInsuficienteException {
    ...
    if(contaOrigem == null){
            throw new RuntimeException("ERRO: Conta de origem não encontrada.");
    }

    if(contaDestino == null){
            throw new RuntimeException("ERRO: Conta de destino não encontrada.");
    }
